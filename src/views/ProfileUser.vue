  ...
  <IonPage>
    ...
    <IonContent>
      ...
      >
          ...
          >
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-96">
              ...
              <form @submit.prevent="updateEmail">
                <div class="mb-4">
                  <label class="block mb-1" for="newEmail"
        ...
        <section class="mb-8">
          <h2 class="text-xl font-semibold mb-2 text-red-500">
            Delete Account
          </h2>
          <p class="mb-4 text-gray-700 dark:text-gray-300">
            Proceed with caution. Make sure you have taken a backup of your
            account in case you ever need to get access to your data. We will
